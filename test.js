...
if (!model_wrapper != undefined) {
    ...
    function modelApp() {
        ...
        function addInteractiveItem() {
            ...
            pointLabel = new CSS2DObject(labelDiv);
            pointLabel.name = "itemLabel";
            pointLabel.position.set(0.5, 0.5, 0);
            pointLabel.center.set(0, 0);
            // pointLabel.visible = false;
            ...
            pointLabel = new CSS2DObject(labelDiv);
            pointLabel.name = "itemLabel";
            pointLabel.position.set(0, 0.85, 0);
            pointLabel.center.set(0, 0);
            // pointLabel.visible = false;
            ...
            pointLabel = new CSS2DObject(labelDiv);
            pointLabel.name = "itemLabel";
            pointLabel.position.set(0.5, 0.85, 0);
            pointLabel.center.set(0, 0);
            // pointLabel.visible = false;
        ...
        function zoomInTimeline(pos, reset = false) {
            if (reset) {
            ...
            //     if (pos.z < 0) {
            //         camTl
            //             .to(controls.target, { x: 0, y: 0, z: 0 })
            //     }
            //     camTl
            ...
            //             camera.position,
            //             {
            //                 x: rotate.x ? pos.x + 12 : pos.x,
            //                 y: pos.y + 3.5,
            //                 z: rotate.z ? pos.z - zoomOutFactor : pos.z + zoomOutFactor,
            //             },
            //             "<"
            //         )
            //     camTl.to(
            ...
            //     //         // maxDistance: 35,
            //     //         minPolarAngle: rotate.x ? Math.PI / 1.5 : Math.PI / 4,
            //     //         maxPolarAngle: rotate.x ? Math.PI / 1.5 : Math.PI / 1.7,
                    ...
                    if (!zoomed) {
                        ...
                        if (e.type == "click") {
                            if (el.clickable == true) {
                                ...
                                instObj.element.classList.add("clicked");
                                ...
                                // console.log(intersect.object.name, camGOTOpos);


                                //heat
                                if (intersect.object.name == "heat_item") {
                                    // camTl.to(controls.target, { x: 0, y: 0, z: 0 })
                                    camTl.to(controls.target, { x: camGOTOpos.x, y: camGOTOpos.y, z: camGOTOpos.z })
                                        .to(
                                            camera.position,
                                            {
                                                x: camGOTOpos.x - 5,
                                ...
                                //fan
                                if (intersect.object.name == "wind_item") {
                                    if (camGOTOpos.z > 0) {
                                        camGOTOpos.z = camGOTOpos.z + 1.8;
                                    }
                                    // camTl.to(controls.target, { x: 0, y: 0, z: 0 })
                                    camTl.to(controls.target, { x: camGOTOpos.x, y: camGOTOpos.y, z: camGOTOpos.z })
                                        .to(
                                ...
                                //scent
                                if (intersect.object.name == "scent_item") {
                                    console.log(camGOTOpos.z);
                                    // camTl.to(controls.target, { x: 0, y: 0, z: 0 })
                                    camTl.to(controls.target, { x: camGOTOpos.x, y: camGOTOpos.y, z: camGOTOpos.z })
                                        .to(
                                            camera.position,
                                ...
                                //camera
                                if (intersect.object.name == "camera_item") {
                                    console.log(camGOTOpos.z);
                                    // camTl.to(controls.target, { x: 0, y: 0, z: 0 })
                                    camTl.to(controls.target, { x: camGOTOpos.x, y: camGOTOpos.y, z: camGOTOpos.z })
                                        .to(
